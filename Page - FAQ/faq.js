document.addEventListener("DOMContentLoaded", function() {
    if (window.location.pathname === "/Page%20-%20FAQ/faq.html") {
...
const faqs = {
    pricing: [
        ...
        { question: "What happens if I cancel before the 12 months is over?", answer: "If you cancel before the 12 months, you owe the full cost of what the site would normally cost ($2,999) minus whatever you have already paid. We prioritize long term relationships with our clients, and want clients to share the same philosophy." },
